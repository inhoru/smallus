...
/**
 * Servlet implementation class HostListSortServlet
 */
@WebServlet("/admin/HostListSortServlet.do")
public class HostListSortServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HostListSortServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String hostSt=request.getParameter("hostSt");
		...
		int totalData=new AdminService().selectHostSortCount(hostSt);
		...
		List<Host> list=new AdminService().checkHostSort(hostSt,cPage,numPerpage);
