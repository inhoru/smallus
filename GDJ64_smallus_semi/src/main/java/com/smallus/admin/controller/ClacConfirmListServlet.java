 ...
 */
@WebServlet("/admin/ClacConfirmListServlet.do")
public class ClacConfirmListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClacConfirmListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/views/admin/adminCalcConfirmList.jsp").forward(request, response);
		}else {
		request.getRequestDispatcher("/views/admin/adminCalcConfirmList.jsp").forward(request, response);
		}
	}
