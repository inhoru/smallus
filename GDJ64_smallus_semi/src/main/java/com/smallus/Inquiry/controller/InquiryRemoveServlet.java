	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 페이징 처리
		  int cPage, numPerpage;
	    	...
	    	new InquiryService().InquiryRemove(loginMember.getMemberId(), remove);
		...
		request.getRequestDispatcher("views/mypage/inquiryRemove.jsp").forward(request, response);
