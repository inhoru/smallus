...
/**
 * Servlet implementation class HostInquiryServlet
 */
@WebServlet("/HostInquiryServlet")
public class HostInquiryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HostInquiryServlet() {
        super();
