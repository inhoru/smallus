...
<div id="m-bodycontainer">
	...
	<div id="m-loginFrm">
		...
		<form id="loginFrm" action="<%=request.getContextPath()%>/host/hostlogin.do" method="post" onsubmit="">
			<table id="loginTable">
			<tr>
				<td>
					아이디
				...
				<td>
					<input type="text" name="hostId" id="hostId" value="<%=savehostId!=null?savehostId:""%>">
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr id="m-checkboxline">
				<td>
					<input type="checkbox" name="savehostId" id="savehostId" <%=savehostId!=null?"checked":"" %>>아이디 저장
				</td>
				<td class="searchId">
