...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/host/hostHeader.css">
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/host/hostMainStyle.css">
...
<body>
	<header>
		<div id="headerContainer">
			...
			%>
			<a href="<%=request.getContextPath()%>/hostMainpage.do"><img
